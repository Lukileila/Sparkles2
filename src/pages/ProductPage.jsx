...
<Steps />
{allEntries.map(({ price,review,description,image,title,fields, sys }) => (
<div  key={id} {...fields} {...sys}  > <div className="bg-white p-10 rounded-lg shadow-lg flex flex-col md:flex-row" style={{maxWidth:'80vw'}}>
